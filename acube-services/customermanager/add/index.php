...
switch($_GET['action']) {
  ...
  function add_customer_data() {
    ...
    $ESTIMATESTATUS     =   0;
    $QUOTEAPPROVED      =   0;
    $qry = "INSERT INTO VIEW_CUSTOMER_MASTER (CUSTOMERID, TYPE, FULLNAME, MOBILE, EMAIL, ADDRESS, COMMENT, CREATEDBY, CREATEDDATE, MODIFIEDDATE, MODIFIEDBY, STATUS, ESTIMATESTATUS, QUOTEAPPROVED) VALUES ('$CUSTOMERID', '$TYPE', '$FULLNAME', '$MOBILE', '$EMAIL', '$ADDRESS','$COMMENT', '$CREATEDBY', '$CREATEDDATE', '$MODIFIEDDATE', '$MODIFIEDBY', '$STATUS', '$ESTIMATESTATUS', '$QUOTEAPPROVED')";
