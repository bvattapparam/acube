(function(){
	...
	function generateESTPDFController($location, $window, $routeParams, $scope, $rootScope, $modalInstance, passingValues, $filter, settings, utilityServices, storageServices, pdfServices, getreferences,$http, mainServices){
	...
	angular.module('aswa').controller('generateESTPDFController',['$location', '$window', '$routeParams', '$scope', '$rootScope', '$modalInstance', 'passingValues','$filter', 'settings', 'utilityServices', 'storageServices', 'pdfServices', 'getreferences', '$http', 'mainServices', generateESTPDFController]);
})();
