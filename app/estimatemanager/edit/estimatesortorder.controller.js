(function(){
	...
	estimateSortOrderController = function($scope, $q, $rootScope, $filter, $modalInstance, passingValues, estimateManagerServices, settingsServices, aswaValidationService, storageServices, getreferences, utilityServices){
		$scope.passingValues 				= 	{};
		...
		$scope.save = function (record) {
            ...
            pushData.ESTIMATEID = $scope.dataBO[0].ESTIMATEID;
            console.log('PUSH DATA ', pushData)
            $rootScope.showSpinner();
                settingsServices.estimateSortOrder(pushData).then(function(data){
                    if(data.msg != ''){
                        $rootScope.hideSpinner();
	...
	angular.module('aswa').controller('estimateSortOrderController', ['$scope', '$q', '$rootScope', '$filter', '$modalInstance', 'passingValues', 'estimateManagerServices', 'settingsServices', 'aswaValidationService', 'storageServices', 'getreferences', 'utilityServices', estimateSortOrderController]);
