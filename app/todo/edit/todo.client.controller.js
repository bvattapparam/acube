(function(){
	...
	todoClientController = function($scope, $q, $rootScope, $filter, $modalInstance, passingValues, poManagerServices, aswaValidationService, storageServices, getreferences, utilityServices){
	...
	angular.module('aswa').controller('todoClientController', ['$scope', '$q', '$rootScope', '$filter', '$modalInstance', 'passingValues', 'poManagerServices', 'aswaValidationService', 'storageServices', 'getreferences', 'utilityServices', todoClientController]);
