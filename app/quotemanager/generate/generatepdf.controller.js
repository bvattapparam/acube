(function(){
	...
	function generateQTPDFController($location, $window, $routeParams, $scope, $rootScope, $modalInstance, passingValues, $filter, settings, utilityServices, storageServices, getreferences,$http, mainServices){
	...
	angular.module('aswa').controller('generateQTPDFController',['$location', '$window', '$routeParams', '$scope', '$rootScope', '$modalInstance', 'passingValues','$filter', 'settings', 'utilityServices', 'storageServices', 'getreferences', '$http', 'mainServices', generateQTPDFController]);
})();
